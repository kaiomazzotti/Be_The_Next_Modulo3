...
namespace ExercicioInterface.Models
{
    ...
    {
        public Coruja(string nome, char sexo, int idade, bool carnivoro, bool peconhento, bool rapina, string corPena) : base(nome, sexo, idade, carnivoro, peconhento, rapina, corPena)
        {
        }
